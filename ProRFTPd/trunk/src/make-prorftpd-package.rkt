...
(define package-dir "prorftpd-package")
(define compiled-dir "compiled")
(define temp-dir (find-system-path 'temp-dir))
(define dest-exe (build-path temp-dir "prorftpd"))
...
(with-handlers ([void (λ (e) 
  ...
  (parameterize ([current-namespace (make-base-namespace)])
    (create-embedding-executable 
     dest-exe
     #:modules '((#f (file "prorftpd.rkt")))
     #:cmdline '("-U" "--")
     #:literal-expression
     (compile '(namespace-require ''prorftpd)))
